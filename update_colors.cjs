...
content = content.replace(/text-yellow-800/g, 'text-amber-900');
content = content.replace(/bg-yellow-50/g, 'bg-amber-50');
content = content.replace(/border-yellow-200/g, 'border-amber-200');
